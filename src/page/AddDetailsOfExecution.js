...
export default function AddDetailsOfExecution() {
    ...
    const handleChange = useCallback(
        (e) => {
            ...
            setDetailsOfExecution({ ...detailsOfExecution, [name]: value });
        },
        [detailsOfExecution]
    );
            ...
            <form onSubmit={(e) => handleAdd(e)}>
                ...
                <div className="detail-div">
                    ...
                    <input
                        name="department"
                        type="text"
                        value={detailsOfExecution.department}
                ...
                <div className="detail-div">
                    <div>목적</div>
                    <input name="objective" type="text" value={detailsOfExecution.objective} onChange={handleChange} />
                </div>
                <div className="detail-div">
                    <div>참여자</div>
                    <input
                        name="participant"
                        type="text"
                        value={detailsOfExecution.participant}
                        onChange={handleChange}
                    />
                </div>
                <div className="detail-div">
